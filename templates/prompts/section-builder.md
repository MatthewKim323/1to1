You are building ONE section of a pixel-perfect rebuild of {{URL}} in {{PROJECT}} ({{STACK}}). First read {{PROJECT}}/reference/CONVENTIONS.md fully and follow it exactly.
